...
Shader "Effect/URP_MaskDissolveDistort_V260709"
{
    Properties
    {
        ...
        _MainTex("主贴图 RGB:颜色 A:透明", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        {
            Name "Unlit"
            // URP 2D Renderer 只会绘制 LightMode 为 SRPDefaultUnlit / Universal2D 的 Pass，
            // UniversalForward 是给 3D Forward Renderer 用的，2D 项目下用它会导致完全不渲染。
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half alpha = mainSample.a * _MainColor.a * vertexColor.a * _Opacity;
